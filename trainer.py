...
def load_training_dataset(path_or_dataset: str = DEFAULT_DATA_PATH) -> Dataset:
...
def train(
    *,
    ...
    name_time = f"{model_name}_{exp_name}_{timestamp}"
    checkpoint_dir = os.path.join(local_output_dir, name_time)
    log_dir = os.path.join('logs', name_time)
    ...
    aim_callback = AimCallback(repo="aim://20.241.212.172:80", experiment=model_name+timestamp)
